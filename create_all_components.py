...
/* Custom Senior Accessibility Font Size Classes */
.font-size-normal {
  font-size: 1rem;
}
.font-size-large {
...
@keyframes glow-pulse {
  0%, 100% {
    box-shadow: 0 0 25px rgba(20, 184, 166, 0.4), inset 0 0 15px rgba(20, 184, 166, 0.2);
  }
  50% {
    box-shadow: 0 0 55px rgba(20, 184, 166, 0.7), inset 0 0 25px rgba(20, 184, 166, 0.5);
  }
}
...
/* Print styles for Clinician PDF & SOAP report */
@media print {
  body {
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // Optional initial speech announcement if on patient tab
    if (accessibility.autoSpeakResponse && activeTab === 'patient_voice') {
...
print("src/index.css & src/context/AppContext.tsx created")
