...
mock_code = """import { PatientProfile, TrendMetric, ClinicalReport } from '../types';
...
with open(f'{base}/src/services/mockData.ts', 'w') as f:
    f.write(mock_code)

print("Updated mockData.ts with clean strings")
